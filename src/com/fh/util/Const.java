...
*/
public class Const {
	public static final String SESSION_SECURITY_PERMITTED = "rcode_permitted";
	...
	public static final String App_NO_INTERCEPTOR_PATH = ".*((login)|(logout)|(/appCode)).*";
	...
	public static final String[] APP_GETAPPUSER_PARAM_ARRAY = new String[]{"USERNAME","PASSWORD","NAME","EMAIL","PHONE"};
	public static final String[] APP_GETAPPUSER_VALUE_ARRAY = new String[]{"用户名","密码","姓名","邮箱","电话"};
